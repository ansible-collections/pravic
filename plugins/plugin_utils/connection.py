...
class RBAConnectionBase(ConnectionBase):
    """Local kubernetes connection plugin"""

    def __init__(self, play_context, new_stdin, *args, **kwargs):
        super(RBAConnectionBase, self).__init__(play_context, new_stdin, *args, **kwargs)
    ...
    def exec_command(self, cmd, in_data=None, sudoable=True):
        ...
        super(RBAConnectionBase, self).exec_command(cmd, in_data=in_data, sudoable=sudoable)
    ...
    def _connect(self):
        ...
        super(RBAConnectionBase, self)._connect()
    ...
    def close(self) -> None:
        ...
        super(RBAConnectionBase, self).close()
